...
const debug = Debug('mngr-ui:components:mixins:stat')
// debug_internals = Debug('mngr-ui:components:mixins:stat:Internals'),
// debug_events = Debug('mngr-ui:components:mixins:stat:Events')
