...
const debug = Debug('mngr-ui:components:mixins:graph')
// debug_internals = Debug('mngr-ui:components:mixins:graph:Internals'),
// debug_events = Debug('mngr-ui:components:mixins:graph:Events')
