...
import InputIOHost from '@libs/input/poller/io.hosts.host'
...
const debug = Debug('mngr-ui:libs:pipelines:hosts.host')
// debug_internals = Debug('mngr-ui:libs:pipelines:hosts.host:Internals'),
// debug_events = Debug('mngr-ui:libs:pipelines:hosts.host:Events')
...
export default {
  ...
  output: [
    function (payload) {
      ...
      if (!payload.err) { EventBus.$emit('hosts.host', payload) }
    }
  ]
}
